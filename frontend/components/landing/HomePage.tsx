            ...
            {faqs.map((item) => (
              ...
              >
                <summary className="list-none cursor-pointer flex items-center justify-between gap-4">
                  ...
                  <span className="text-primary text-2xl leading-none transition-transform duration-300 ease-out group-open:rotate-45">+</span>
                </summary>
                <div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out group-open:grid-rows-[1fr]">
                  <div className="overflow-hidden">
                    <p className="pt-4 text-muted-foreground leading-relaxed opacity-0 translate-y-1 transition-all duration-300 ease-out group-open:opacity-100 group-open:translate-y-0">
                      {item.answer}
                    </p>
                  </div>
                </div>
